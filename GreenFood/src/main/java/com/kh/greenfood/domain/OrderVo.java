...
public class OrderVo {
		...
		public String toString() {
			return "OrderVo [user_id=" + user_id + ", order_code=" + order_code + ", order_date=" + order_date
					...
					+ ", order_point_use=" + order_point_use + ", order_origin_price=" + order_origin_price
					+ ", order_state=" + order_state + ", order_state_dsc=" + order_state_dsc + ", order_addr1="
					+ order_addr1 + ", order_addr2=" + order_addr2 + ", order_addr3=" + order_addr3
