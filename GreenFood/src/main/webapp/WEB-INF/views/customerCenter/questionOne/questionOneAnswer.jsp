...
$(function(){
	...
	$("#btnList").click(function(){
		location.href="/customerCenter/questionOne/questionOneContent";
	});
...
// --------------------- 수정 후 수정완료 누르면 입력한 값 넘겨주기 -----------------------
	$("#btnUpdateFinish").click(function() {
		var q_o_title = $("#q_o_title").val(); // title 입력한 값 지정
		var q_o_content = $("#q_o_content").val(); // content 입력한 값 지정
		$("#frmUpdate > input[type=hidden]").eq(1).val(q_o_title); // 붙여넣기
		$("#frmUpdate > input[type=hidden]").eq(2).val(q_o_content); // 붙여넣기
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="question_page_top">
				<h2 class="question_tit">1:1 문의 답변</h2>
				<h2 class="question_sub">문의하신 내용의 답변을 확인하세요</h2>
			</div>
				<div class="row">
